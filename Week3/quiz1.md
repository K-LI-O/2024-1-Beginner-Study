...
- 답: 1은 브랜치의 커밋을 그대로 merge하고, 2는 브랜치의 커밋을 합쳐 merge하며 3은 브랜치 커밋의 시작점을 변경합니다. 
...
- 답: 가장 최근에 한 커밋의 아이디는 a1s3d3f, develop 브랜치에서 커밋, 해당 커밋 메시지.
...
- 답: revert를 선택합니다. 되돌리려는 커밋에서 다른 사람이 작업 영역일수도 있기 때문입니다.